...
=======
=======
>>>>>>> 6c7235a... Starting to consolidate the AssignmentView and AssignmentStudent classes.  They overlap so much that it'll just be simpler to combine them.
  expected_element :editor
...
>>>>>>> 04e1e2e... Finished the Assignments Grading spec.
